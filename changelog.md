...
- 2026-07-21 — Rebuilt the documentation candidate from current trusted `main`, preserving accepted consent controls and adding retained exact-head documentation-site evidence without enabling Pages publication.
...
- Release remains blocked until current-main P0 acceptance, P2 independent permission separation, P3 conformance, G0 portfolio gluing, retained artifacts, strict documentation validation, provenance, rollback, legal/privacy review, and explicit human approval are complete.
